...
# coq_makefile -o Makefile axioms.v cardinal.v category.v cat_examples.v colimits.v equalizer.v fc_limits.v fiprod.v fmachine.v functions.v functor_cat.v functor.v limits.v little_cat.v nat_trans.v notation.v order.v ordinal.v set_theory.v tactics.v transfinite.v universe.v 
#
